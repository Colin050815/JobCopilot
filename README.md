...
- 🏠 **首页推荐投递**：可读取 BOSS 首页“精选职位”，强制用目标关键词与简历筛掉陪玩等无关岗位后再人工审核
...
| 岗位来源 | “关键词搜索结果”或“BOSS 首页推荐”；首页推荐固定使用 AI 相关性筛选 |
...
如需投递首页推荐岗位，先在 BOSS 首页确认“精选职位”已经显示，再把 **岗位来源** 改为 **BOSS 首页推荐（强制 AI 筛选）**。填写目标岗位关键词并准备简历文字后开始收集；方向无关的推荐岗位会显示为不可勾选，不会进入投递批次。
